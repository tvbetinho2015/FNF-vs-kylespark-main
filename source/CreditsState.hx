...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Void Team'],
			['BITT',		'tvbetinho',	'Creator of mod',		'https://twitter.com/tvbetinho2015',	'03A9FC'],
			['Ruiza Yura',	'ruizayura',	'Programer',		'https://twitter.com/ruizayura',	'E5444A'],
			['Applk Clips', 'ac',	'Background Artist',	'https://twitter.com/ApplkClips',	'3EFF00'],
			['Al3xo',	'al3xo',	'Original composer of Cosmic Void',		'https://www.youtube.com/channel/UCBoXrVCRGJEOAuUTGY6pcxA', '14995D'],
			[''],
			['The mod Contributors'],
			['KylesPark',	'kylespark',	'Great inspiration',		'https://www.youtube.com/channel/UCbou20B2BReLiAuuRSE8pgA',			'FF6485A3'],
			[''],
			['Psych Engine Team'],
